      ...
      <div className="container mx-auto p-6 bg-white rounded-lg shadow-xl">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-6">
          ...
          <div className="flex items-center space-x-4 w-full lg:w-1/2">
            ...
            />
            <Link to={`/worker/search?query=${searchTerm}`} className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">
              Search
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-6">
          ...
          <div className="flex-1 lg:w-2/3 bg-gradient-to-br from-indigo-50 to-yellow-100 p-4 rounded-lg shadow-md border border-yellow-200">
            ...
            <div className="text-center mt-4">
              <Link to="/worker/job-recommendations" className="inline-block px-4 py-2 bg-indigo-500 text-white rounded hover:bg-indigo-600">
                See More
              </Link>
            </div>
          </div>
